...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    public final void setFooterBackground(Drawable backgroundDrawable) {
        ViewCompat.setBackground(mFooterLayout, backgroundDrawable);
    }
    ...
    public final void setHeaderBackground(Drawable backgroundDrawable) {
        ViewCompat.setBackground(mHeaderLayout, backgroundDrawable);
    }
