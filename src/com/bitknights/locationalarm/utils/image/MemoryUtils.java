...
import com.bitknights.locationalarm.utils.image.memory.IMemInfoReader;
import com.bitknights.locationalarm.utils.image.memory.MemInfoReader;
...
public final class MemoryUtils {
    ...
    public static long getTotalMemorySize() {
        if (sTotalMemorySize < 0) {
            IMemInfoReader reader = MemInfoReader.getInstance();
            reader.readMemInfo();
            ...
            sTotalMemorySize = reader.getTotalSize(); // Runtime.getRuntime().totalMemory()
        }
