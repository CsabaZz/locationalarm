...
public class LaunchActivity extends FragmentActivity implements Runnable, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mDrawerToggle = new DrawerToggle(this, this.mDrawerLayout, R.drawable.ic_drawer,
    ...
    private void showInstallDialog() {
        ...
        if (checkGooglePlayServices != ConnectionResult.SUCCESS) {
            GooglePlayServicesUtil.getErrorDialog(checkGooglePlayServices, this,
                    REQUEST_GOOGLEPLAY_SERVICES).show();
        }
    }
    ...
    private Intent createShareIntent() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TITLE, ""); // TODO put valid title
                                                      // into share Intent
        shareIntent.putExtra(Intent.EXTRA_TEXT, ""); // TODO put valid text into
                                                     // share Intent
        return shareIntent;
    }
    ...
    private void addHomePage() {
        ...
        if (fragment != null) {
            ...
            this.mLocationFragment = LocationsFragment.instantiate(this,
    ...
    public void changeFragment(BaseFragment fragment, boolean animate) {
        ...
        if (fragment.isAdded()) {
            ...
            final FragmentManager manager = getSupportFragmentManager();
            final FragmentTransaction transaction = manager.beginTransaction();
            transaction.setCustomAnimations(R.animator.push_right_in, R.animator.push_left_out,
                    R.animator.push_left_in, R.animator.push_right_out);
    ...
    private Fragment findFragmentById(int parentId) {
        return getSupportFragmentManager().findFragmentById(parentId);
    }
